...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->registrationSucceeded((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterDialog::*)(const QString & )>(_a, &RegisterDialog::registrationSucceeded, 0))
            return;
    }
}
...
// SIGNAL 0
void RegisterDialog::registrationSucceeded(const QString & _t1)
{
